...
/**
 * Task5: Using a Compound Condition with Conditional Operator or Ternary
 * 
 * 
 */
int main()
{
    ...
    std:: cin >> day;
    std::string msg=(month>=1 && month<=12)?
    "you entered a valid month" : "you entered an invalid month";
